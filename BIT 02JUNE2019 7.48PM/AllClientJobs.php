...
<div class="topnav" id="topnav">
  ...
  <a href="./staffJobAssignment.html" >New Job Assignment</a>
  <a href="clients.php"> All Clients </a>
  <a href="contractors.php"> All Contractors </a>  
  <a href="./payment.html" class="w3-bar-item w3-button"><i class="fa fa-envelope"></i>Payment</a>
...
<!--  Navbar division End  -->
	<?php
		...
		$result = mysqli_query($db,"select * from bit_contractor");
