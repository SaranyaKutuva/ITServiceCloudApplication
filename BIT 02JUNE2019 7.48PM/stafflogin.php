  ...
  <?php
   session_start();
	...
	else
	{
		...
		$result = mysqli_query($db,"select JobRequest_Id,bit_contractor.Contractor_Id,concat(bit_contractor.FirstName 
,' ',bit_contractor.LastName) as ContractorName,RequestDate,Hours_Worked,KiloMeterTravelled	from bit_job_request,bit_contractor
		...
		<th>Actions</th>
			...
			while ($row = mysqli_fetch_array($result))
			{
				echo "<tr>
					  ...
					  <td>".$row['KiloMeterTravelled']."</td>
					 
		        	  <td> <button onClick=insert() >VERIFIED</button></td>
					  </tr>";
			}
		echo "</table>";
